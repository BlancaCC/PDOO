...
class CardDealer {
    ...
    private void createEnemies() {
        ...
        */
        ...
        enemies.add(new EnemyStarShip("Enemigo transforma 2",0,0,transformLoot0,regularDamage0));  
        enemies.add(new EnemyStarShip("Enemigo transforma 3",0,0,transformLoot0,regularDamage0));  
